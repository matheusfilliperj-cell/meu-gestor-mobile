    ...
    if p < len(df):
        ...
        with st.container(border=True):
            ...
            if len(tel_limpo) >= 8:
                ...
                with c2:
                    st.markdown(f'''<a href="https://wa.me/55{tel_limpo}?text=Olá%20{info_atual}%2C%20tudo%20bem%3F%20Eu%20me%20chamo%20Matheus%2C%20sou%20corretor%20de%20imóveis%20e%20vi%20aqui%20no%20sistema%20que%20se%20interessou%20por%20um%2C%20por%20isso%2C%20gostaria%20de%20fazer%20algumas%20perguntas%3A" target="_blank" style="text-decoration:none;">
